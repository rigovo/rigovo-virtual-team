...
def get_engineering_roles() -> list[AgentRoleDefinition]:
    ...
    return [
        AgentRoleDefinition(
            ...
            default_tools=[
                "read_file", "list_directory", "search_codebase", "read_dependencies", "consult_agent",
            ],
        ...
        AgentRoleDefinition(
            ...
            default_tools=[
                ...
                "run_command", "read_dependencies", "consult_agent",
            ],
            preferred_tier="standard",
            pipeline_order=1,
            produces_code=True,
        ...
        AgentRoleDefinition(
            ...
            default_tools=[
                "read_file", "write_file", "list_directory", "run_command", "consult_agent",
            ],
        ...
        AgentRoleDefinition(
            ...
            default_tools=["read_file", "write_file", "list_directory", "run_command", "consult_agent"],
            preferred_tier="budget",
            pipeline_order=6,
            produces_code=True,
        ),
